...
public class Main {
    ...
    public static void consultas () throws IOException, ParseException {
        while (true) {
            System.out.println(
                    ...
                    "\n5. Top 5 cervezas con más reseñas." +
                ...
                if (entradaConsultas.equals("1")) {
                    ...
                    try {
                        ...
                        if (!Validaciones.numberIsCorrect(añoConsulta1String, 1996, 2012)) {
                            System.out.println("\nNo hay datos para el año ingresado, pruebe con un año entre 1996 y 2012.");
                        } else {
                    ...
                    Scanner entradaScanConsulta3 = new Scanner(System.in);

                    System.out.println("\nIntroduzca la fecha inicial en formato dd/MM/yyyy:");
                    String fechaInferior = entradaScanConsulta3.nextLine();

                    System.out.println("\nIntroduzca la fecha final en formato dd/MM/yyyy:");
                    String fechaSuperior = entradaScanConsulta3.nextLine();

                    try {
                        Date startDate = new SimpleDateFormat("dd/MM/yyyy").parse(fechaInferior);
                        Date endDate = new SimpleDateFormat("dd/MM/yyyy").parse(fechaSuperior);

                        if (startDate.equals(endDate) || startDate.before(endDate)) {
                            // Se corre la consulta 3.
                            Consultas.consulta3(startDate, endDate);
                        } else {
                            System.out.println("\nLa fecha inicial debe ser anterior a la final.");
                        }
                    } catch (ParseException excepcion){
                        System.out.println("\nAlguna de las fechas no tiene el formato correcto.");
                    }
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        while (true) {
            ...
            if (!Validaciones.numberIsCorrect(entradaMenu, 1, 3)) {
                ...
                if(!datosCargados){
                    System.out.println("\nDeben cargarse los datos antes de realizar las consultas.");
                } else {
                    Main.consultas();
                }
